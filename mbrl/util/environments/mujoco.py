...
from mbrl.util.environments.base import MBRLCompatEnv
...
class MujocoEnv(MBRLCompatEnv):
    def __init__(self, cfg):
            """Creates a Mujoco environment from a given OmegaConf configuration object.
